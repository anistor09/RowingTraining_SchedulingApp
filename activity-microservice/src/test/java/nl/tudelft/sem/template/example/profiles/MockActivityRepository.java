...
/**
 * A configuration profile to allow injection of a mock ActivityRepository.
 ...
 */
@Profile("mockActivityRepository")
@Configuration
public class MockActivityRepository {

    /**
     * Mocks the ActivityRepository.
     *
     * @return A mocked ActivityRepository.
     */
    @Bean
    @Primary
    public ActivityRepository getMockActivityRepository() {
