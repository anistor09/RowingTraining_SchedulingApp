...
/**
 * A configuration profile to allow injection of a mock NotificationService.
 ...
 */
@Profile("mockNotificationService")
@Configuration
public class MockNotificationService {

    /**
     * Mocks the NotificationService.
     *
     * @return A mocked NotificationService.
     */
    @Bean
    @Primary
    public NotificationService getMockNotificationService() {
