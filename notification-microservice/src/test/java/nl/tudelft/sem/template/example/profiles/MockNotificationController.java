...
/**
 * A configuration profile to allow injection of a mock NotificationController.
 ...
 */
@Profile("mockNotificationController")
@Configuration
public class MockNotificationController {

    /**
     * Mocks the NotificationController.
     *
     * @return A mocked NotificationController.
     */
    @Bean
    @Primary
    public NotificationController getMockNotificationController() {
        return Mockito.mock(NotificationController.class);
    }
}
